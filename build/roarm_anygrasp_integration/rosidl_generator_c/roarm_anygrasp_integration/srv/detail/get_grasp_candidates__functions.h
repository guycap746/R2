...
#ifndef ROARM_ANYGRASP_INTEGRATION__SRV__DETAIL__GET_GRASP_CANDIDATES__FUNCTIONS_H_
#define ROARM_ANYGRASP_INTEGRATION__SRV__DETAIL__GET_GRASP_CANDIDATES__FUNCTIONS_H_
...
/// Initialize srv/GetGraspCandidates message.
/**
...
/// Finalize srv/GetGraspCandidates message.
/**
...
/// Create srv/GetGraspCandidates message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roarm_anygrasp_integration__srv__GetGraspCandidates_Request__init().
...
/// Destroy srv/GetGraspCandidates message.
/**
 * It calls
 * roarm_anygrasp_integration__srv__GetGraspCandidates_Request__fini()
...
/// Check for srv/GetGraspCandidates message equality.
/**
...
/// Copy a srv/GetGraspCandidates message.
/**
...
/// Initialize array of srv/GetGraspCandidates messages.
/**
...
/// Finalize array of srv/GetGraspCandidates messages.
/**
 * It calls
 * roarm_anygrasp_integration__srv__GetGraspCandidates_Request__fini()
...
/// Create array of srv/GetGraspCandidates messages.
/**
 * It allocates the memory for the array and calls
 * roarm_anygrasp_integration__srv__GetGraspCandidates_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetGraspCandidates messages.
/**
 * It calls
 * roarm_anygrasp_integration__srv__GetGraspCandidates_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetGraspCandidates message array equality.
/**
...
/// Copy an array of srv/GetGraspCandidates messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * roarm_anygrasp_integration__srv__GetGraspCandidates_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_anygrasp_integration
...
/**
 * It calls
 * roarm_anygrasp_integration__srv__GetGraspCandidates_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_anygrasp_integration
...
/**
 * It allocates the memory for the array and calls
 * roarm_anygrasp_integration__srv__GetGraspCandidates_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_roarm_anygrasp_integration
...
/**
 * It calls
 * roarm_anygrasp_integration__srv__GetGraspCandidates_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROARM_ANYGRASP_INTEGRATION__SRV__DETAIL__GET_GRASP_CANDIDATES__FUNCTIONS_H_
