...
static const _GetPoseCmd_Request_type_support_symbol_names_t _GetPoseCmd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roarm_moveit, srv, GetPoseCmd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roarm_moveit, srv, GetPoseCmd_Request)),
  }
};
...
get_message_type_support_handle<roarm_moveit::srv::GetPoseCmd_Request>()
{
  return &::roarm_moveit::srv::rosidl_typesupport_cpp::GetPoseCmd_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, roarm_moveit, srv, GetPoseCmd_Request)() {
  return get_message_type_support_handle<roarm_moveit::srv::GetPoseCmd_Request>();
}
...
static const _GetPoseCmd_Response_type_support_symbol_names_t _GetPoseCmd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roarm_moveit, srv, GetPoseCmd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roarm_moveit, srv, GetPoseCmd_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<roarm_moveit::srv::GetPoseCmd_Response>()
{
  return &::roarm_moveit::srv::rosidl_typesupport_cpp::GetPoseCmd_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, roarm_moveit, srv, GetPoseCmd_Response)() {
  return get_message_type_support_handle<roarm_moveit::srv::GetPoseCmd_Response>();
}
...
static const _GetPoseCmd_type_support_symbol_names_t _GetPoseCmd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roarm_moveit, srv, GetPoseCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roarm_moveit, srv, GetPoseCmd)),
  }
};
...
get_service_type_support_handle<roarm_moveit::srv::GetPoseCmd>()
{
  return &::roarm_moveit::srv::rosidl_typesupport_cpp::GetPoseCmd_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, roarm_moveit, srv, GetPoseCmd)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<roarm_moveit::srv::GetPoseCmd>();
}
